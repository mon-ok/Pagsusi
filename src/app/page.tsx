...
import { MapPin, TrendingUp, AlertTriangle, HelpCircle, Menu } from "lucide-react";
...
export default function Home() {
  ...
  const handleAnomalySelect = (item: AnomalyData) => {
  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col bg-[#E9DFCB] font-sans dark:bg-black">
      <header className="bg-[#62180F] shrink-0">
        <div className="z-10 px-0 sm:px-2 md:px-4 py-4 md:py-6 text-[#D8BB7B] flex justify-between items-start lg:items-center w-full">
            <Sheet open={isMenuOpen} onOpenChange={setMenuOpen}>
              <SheetTrigger asChild>
                <button className="lg:hidden p-2 hover:bg-white/10 rounded-full transition-colors" aria-label="Open Menu">
              ...
              <SheetContent side="left" className="w-[300px] sm:w-[400px] bg-white p-0">
                <div className="bg-white rounded-lg shadow-sm overflow-hidden flex flex-col h-full">
                  ...
                  <div className="overflow-y-auto divide-y divide-border">
                    {data.map((item) => (
                      <div key={item.id} className="p-3 cursor-pointer hover:bg-gray-50" onClick={() => handleAnomalySelect(item)}>
            ...
            <div className="flex-1 lg:flex-none lg:ml-4 text-center lg:text-left">
